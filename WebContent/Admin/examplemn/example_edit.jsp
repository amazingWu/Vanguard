...
<body marginwidth="0" marginheight="0">
	<div class="container">
		<div class="public-nav">您当前的位置：<a href="">管理首页</a>编辑案例</div>
		<div class="public-content">
			<div class="public-content-header">
				<h3>编辑案例</h3>
			</div>
			<div class="public-content-cont">
			<form action="<%=path%>/Admin/UpdateExample" method="post">
			<input type="text" style="visibility: hidden;" name="example.example_id" value="${example.example_id}">
				<input type="text" style="visibility: hidden;" name="example.example_time" value="${example.example_time}">
				<input type="text" style="visibility: hidden;" name="example.example_header" value="${example.example_header}">
				<input type="text" style="visibility: hidden;" name="example.example_index" value="${example.example_index}">
				...
				<div class="form-group">	
					...
					<input class="form-input-txt" type="text" id="photo"  name="example.example_photo" value="${example.example_photo }" />
				</div>
				<div class="form-group">
